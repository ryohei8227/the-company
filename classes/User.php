...
class User extends Database {
    ...
    public function store($request){
        ...
        ('$first_name', '$last_name', '$userame', '$password')";
    ...
    public function login($request){
        ...
        if($result->num_rows == 1){
            ...
            // $user = ['id' = 1, 'username => 'Ryohei123', 'password' => 'aiueo123'.....]
    ...
    public function update($request, $files){
        ...
        if($this->conn->query($sql)){
            ...
            # Check if there is ana uploaded photo, save it to the database and save the file to images folder.
            if($photo){
